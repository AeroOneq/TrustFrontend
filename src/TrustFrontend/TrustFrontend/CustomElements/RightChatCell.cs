...
{
    public class RightChatCell : ContentView
	{
        #region LeftChatCell's views
        private Label messageTextLabel;
        private Label messageTimeLabel;
        private Label messageAuthorLabel;
        ...
        public readonly BindableProperty MessageAuthorBindable = BindableProperty.Create(
            "MessageAuthor", typeof(string), typeof(LeftChatCell));
        public string MessageAuthor
        {
            get => GetValue(MessageAuthorBindable) as string;
            set
            {
                SetValue(MessageAuthorBindable, value);
                messageAuthorLabel.Text = value;
            }
        }
        #endregion
        public RightChatCell ()
		{
            ...
            backgroundLayout.Children.Add(messageAuthorLabel);
